...
class MetingJSElement extends HTMLElement {
    ...
    _init() {
        ...
        this.config=a,
        // this.api=this.meta.api||window.meting_api||"https://meting.zhheo.com/?server=:server&type=:type&id=:id&auth=:auth&r=:r",
        this.api=this.meta.api||window.meting_api||"https://api.g-haoyu.top/msclist", 

        this.meta.auto&&this._parse_link()
    }

    _parse_link() {
        let a=[["music.163.com.*song.*id=(\\d+)",
        "netease",
        "song"],
    ...
    _parse() {
        if(this.meta.url) {
            let a= {
                name: this.meta.name||this.meta.title||"Audio name", artist:this.meta.artist||this.meta.author||"Audio artist", url:this.meta.url, cover:this.meta.cover||this.meta.pic, lrc:this.meta.lrc||this.meta.lyric||"", type:this.meta.type||"auto"
            }
    ...
    _loadPlayer(a) {
        let b= {
            audio: a, mutex: !0, lrcType:this.meta.lrcType||3, storageName:"metingjs"
        }
